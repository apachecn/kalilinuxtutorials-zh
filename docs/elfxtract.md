...
> 原文：<https://kalilinuxtutorials.com/elfxtract/>

[![](img/61cda6b693b20f9d6f90815594f858f8.png)](https://blogger.googleusercontent.com/img/a/AVvXsEhhT9byhdCupaaRI4M6QgWS2oQqQyInxuxaAFWxiduKBjjucUWMjjKmdFJr-6xKblhTWBnJNfNxZ5GfVUvWJ9K6N0_f-P05Nv6RlR1Aw1Wue29WfbWXbqwV5W5eUF1yhKoskpHYldkVxH8nlfrlJFL2Ubgk7ZlBTHDUfB-a5j3slJAQ9ABDbE-uw03g=s728)

**ELFXtract** 是一个用于枚举 ELF 二进制文件的自动化分析工具。由[雷达 2](https://github.com/radareorg/radare2) 和 [r2ghidra](https://github.com/radareorg/r2ghidra) 提供动力
...
**elfxtract** 完全是为解析 PWN 二进制而开发的，

很快，它将增加分析系统二进制文件的新功能

此外，自动 BOF 和自动返回 2 开发功能将被添加
