...
> 原文：<https://kalilinuxtutorials.com/microsoft-windows-hacking-pack-whp/>

这里用于 Windows Hacking Pack 的工具来自不同的来源。回购协议通常获得 WTFPL 的许可，但有些内容可能没有(例如 sysinternals)。“pes”的意思是“PE Scambled”。有时候很有用。
...
[![](img/a51de913dc60eee505c4a68651ee8e4d.png)](https://github.com/51x/WHP)

**也读作 [Bad-PDF 从 Windows 机器上窃取 NTLM 哈希](http://kalilinuxtutorials.com/steal-ntlm-hashes-windows-machines/)**