# Solarflare:网络安全管理软件产品猎户座帐户审计/密码转储实用程序

> 原文：<https://kalilinuxtutorials.com/solarflare/>

[![Solarflare : SolarWinds Orion Account Audit / Password Dumping Utility](img/77a57e7fb1e9c45d6900c8279a94d9fc.png "Solarflare : SolarWinds Orion Account Audit / Password Dumping Utility")](https://1.bp.blogspot.com/-_wzTU9s44vE/X_yViTGVKUI/AAAAAAAAITw/9wg_uC2xhzw4RmzYOy8DEj-vgN2ffpDIQCLcBGAsYHQ/s728/Solarflare%25281%2529.png)

Solarflare 是网络安全管理软件产品猎户座的凭证转储工具。
...
**感谢:**[@阿索利诺](https://github.com/asolino)、[@真蒂基维](https://github.com/gentilkiwi)、[@斯凯尔塞](https://github.com/skelsec)帮我弄清楚了 DPAPI。

[**Download**](https://github.com/mubix/solarflare)